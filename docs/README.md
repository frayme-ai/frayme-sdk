...
{% hint style="info" %}
The SDKs are on npm (`npm i @frayme/api @frayme/runtime`) and everything in these docs is ready to wire up. API keys are issued from your Frayme dashboard at [frayme.ai](https://frayme.ai).
{% endhint %}
...
| [API reference](api/) | Every endpoint, parameter, event, and error code |
...
| [Examples](examples/) | Runnable apps: live demos at [frayme.ai/examples](https://frayme.ai/examples) |
| [Resources](resources/pricing.md) | Pricing, changelog, support |
...
| --- | --- | --- |
| [`@frayme/api`](https://www.npmjs.com/package/@frayme/api) | 0.5.0 | Zero-dependency API client: streaming, typed errors, retries that can't double-bill, agent tools for every major framework (`fraymeTools()` for the Vercel AI SDK), and a ready-made server proxy (`createFraymeHandler()`) |
| [`@frayme/runtime`](https://www.npmjs.com/package/@frayme/runtime) | 0.5.0 | Renders specs as live React 19: full 189-component registry, `--frayme-*` CSS theming, AI SDK and AG-UI adapters |
| [`@frayme/catalog`](https://www.npmjs.com/package/@frayme/catalog) | 0.4.0 | The component vocabulary: schemas, `fraymeCatalog.validate()`, and bring-your-own-component manifests |

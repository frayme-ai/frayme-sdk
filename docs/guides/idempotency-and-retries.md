...
- A streaming replay is an instant burst: `compose.started`, every stored op, then `compose.completed`. Same shape as a live stream, delivered at once — your rendering path needs no special case.
